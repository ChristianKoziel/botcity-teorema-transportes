...
class Bot(DesktopBot) :
    ...
    def action(self,execution=None) :
                ...
                if not bot.find("btn_menu_empresas", matching=0.97, waiting_time=10000):
                    not_found("btn_menu_empresas")                                                                      
                bot.click()
                # Searching for element 'btn_Incluir_2508 '
                if not bot.find("btn_Incluir_2508", matching=0.97, waiting_time=10000):
                    not_found("btn_Incluir_2508")
                bot.click()
                ...
                # Searching for element 'LP_Localizar_2508 '
                if not bot.find("LP_Localizar_2508", matching=0.97, waiting_time=10000):
                    not_found("LP_Localizar_2508")
                bot.click()
                ...
                self.enter()
                self.enter()'''
                # # Searching for element 'lixeiraNovaPequena_2508 '
                # if not bot.find("lixeiraNovaPequena_2508", matching=0.97, waiting_time=10000):
                #     not_found("lixeiraNovaPequena_2508")
                # bot.click_relative(9, -17)
                self.enter()
                if not bot.find("add_est", matching=0.97, waiting_time=10000):
                    not_found("add_est")
                bot.click_relative(-30, 7)
                ...
                self.tab()
                self.enter()
                # Searching for element 'xVermelho_2508 '
                if not bot.find("xVermelho_2508", matching=0.97, waiting_time=10000):
                    not_found("xVermelho_2508")
                bot.click()
                self.enter()
